...
window.location.href = '/login';
    ...
    const data = { VerificarExpericacionToken, SubmitLogin, usuarioLogeado, AuthuTokenYUsiario, SubmintCrearServicio, SubmitRegistro, listaServicios, serviciosBack, seleccionarServicio, servicio, arrayTurnos, listaTurnos, eliminarTurno,logOut }
