  ...
  return (
    <>
      <form className="row g-3" encType='"multipart/form-data"' >
        ...
        <div className="col">
          <label htmlFor="nombref" className="form-label">Nombre del servicio</label>
        ...
        <div className="col">
          <label htmlFor="direccionf" className="form-label">Costo</label>
          <input type="number" className="form-control" id="direccionf" placeholder="1234 Main St" name='costo' onChange={handleChange} />
        </div>
        <div className="col">
