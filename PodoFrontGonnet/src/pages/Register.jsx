 ...
 */}
            ...
            <form>
                <div id="main2">
                    <p id="code1"> <span className="rotated-text">INGRESE SUS DATOS POR FAVOR !</span></p>
                    <div id="inset">
                        <div>
                            <input type="text" placeholder="nombre de usuario" id="exampleInputEmail1" name='userName' onChange={handleChange} />
                        </div>
                        <div>
                            <input type="text" placeholder="nombre" id="exampleInputEmail1" name='name' onChange={handleChange} />
                        </div>
                        <div>
                            <input type="text" placeholder="email" id="exampleInputEmail1" name='email' onChange={handleChange} />
                        </div>
                        <div>
                            <input type="text" placeholder="password" id="exampleInputEmail1" name='password' onChange={handleChange} />
                        </div>
                        <div>
                            <input type="text" placeholder="repetir password" id="exampleInputEmail1" name='repeatePassword' onChange={handleChange} />
                        </div>
                        <div>
                        
                            <button type="submit"  className='registrobutton' onClick={(e) => { SubmitRegistro(e, form) }} >Registrarse</button>
                            <button type="submit" className='registrobutton'><Link to={'/'} className='Linkclass'>Ir a Inicio</Link></button> 
                        </div>
                    </div>
